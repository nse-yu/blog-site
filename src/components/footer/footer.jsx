            ...
            <footer css={[
                ...
                <section className="footer__media" css={[utilSet.horizontalize]}>
                    <div className="footer__media-logo">
                        <a href="https://twitter.com/nagachon0000">
                            <motion.svg
                                whileHover={{fill:"#e6e68a"}}
                                xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="#ffffff"
                            >
                    ...
                    <div className="footer__media-logo">
                        <a href="https://www.facebook.com/profile.php?id=100051614810790">
                            <motion.svg
                                whileHover={{fill:"#b8e68a"}}
                                xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="#ffffff">
